...
@interface octa_stops_vc ()

@end

@implementation octa_stops_vc
...
- (void)viewDidLoad
{
    ...
    NSLog(@"in view did load of octa stops");
    self.rv= [[NSArray alloc] init];
    
    self.rv = [[octa_db database ] allStops:self.tr.routes];
...
-(void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    ...
    if ([segue.identifier isEqualToString:@"octa_s_map"]){
        octa_map_vc* detailVC = segue.destinationViewController;
