...
#import "octa_routes_vc.h"
#import "octa_db.h"


@interface octa_routes_vc ()

@end

@implementation octa_routes_vc
NSArray* rv;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([tr1.available_days isEqualToString:@"WD"]) {
        ...
        UIImage* anImage = [UIImage imageNamed:@"octa_info.jpeg"];
        
         [[cell imageView] setImage:anImage];
        cell.detailTextLabel.text = [NSString stringWithFormat:@"weekdays "];
    }
...
-(void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    ...
    if ([segue.identifier isEqualToString:@"octa_r_s"]){
        octa_stops_vc* detailVC = segue.destinationViewController;
